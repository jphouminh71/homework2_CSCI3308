function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        if(myInput.value.match(lowerCaseLetters)) {   // if we come in here then that means the input is correct, change the class
        ...
        if(myInput.value.match(upperCaseLetters)) { // if we come in here then that means the input is correct, change the class
        ...
        // Validate numbers
        if(myInput.value.match(numbers)) {  // if we come in here then that means the input is correct, change the class
        ...
        // Validate length
        if(myInput.value.length >= minLength) { // if we come in here then that means the input is correct, change the class
    ...
    confirmMyInput.onkeyup = function() {
                ...
                if(passEqualsConfPass) {      // change to valid if true
                    match.classList.remove("invalid");
                    match.classList.add("valid");
                } else {                      // change it back to an invalid input
                    match.classList.remove("valid");     // revert back to invalid input
...
function enableButton(letter, capital, number, length, match) {
    ...
    if(condition) {     // if this is true then the button should be enabled
            button.disabled = false;
        } else{       // otherwise have the disable be true
